...
const DashboardPage = () => {
  ...
  const stats = [
    ...
    { label: 'AI Processed Queries', value: 'Fetching...', change: 'Active', icon: MessageSquare, color: 'teal' },
    ...
    <div className="flex min-h-screen bg-white pt-28 text-[#0a2540]">
      ...
      <aside className="w-72 border-r border-gray-100 p-8 hidden lg:block bg-gray-50/50">
        <div className="space-y-12">
          ...
          <div className="pt-12 border-t border-gray-100">
            <button className="flex items-center gap-4 px-4 py-3 text-red-500 hover:bg-red-50 w-full rounded-xl transition-all font-bold text-sm">
      ...
      <main className="flex-1 p-8 lg:p-12 overflow-y-auto bg-gray-50/30">
        <header className="flex flex-col sm:flex-row justify-between sm:items-end gap-6 mb-12">
          <div>
            <h1 className="text-4xl font-black tracking-tighter uppercase mb-2 text-[#0a2540]">Practice <span className="text-gradient-clinical">Dashboard</span></h1>
          ...
          <div className="flex gap-4">
            ...
            <div className="w-12 h-12 bg-[#0a2540] text-white rounded-xl flex items-center justify-center font-black shadow-sm">DR</div>
          </div>
        </header>
